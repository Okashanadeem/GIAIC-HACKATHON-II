...
The future of software development is **AI-native and spec-driven**. As AI agents like Gemini CLI become more powerful, the role of the engineer shifts from "syntax writer" to "system architect." We have already explored Spec-Driven Book Authoring. Now, we want you to master the **Architecture of Intelligence**.

In this hackathon, you will master the art of building applications iteratively—starting from a simple console app and evolving it into a fully-featured, cloud-native AI chatbot deployed on Kubernetes. This journey will teach you the [Nine Pillars of AI-Driven Development](https://ai-native.panaversity.org/docs/Introducing-AI-Driven-Development/nine-pillars), [Gemini CLI](https://ai-native.panaversity.org/docs/AI-Tool-Landscape/claude-code-features-and-workflows), [Spec-Driven Development with Reusable Intelligence](https://ai-native.panaversity.org/docs/SDD-RI-Fundamentals) and Cloud-Native AI technologies through hands-on implementation.
...
* Spec-Driven Development using Gemini CLI and Spec-Kit Plus  
...
* AIOps with kubectl-ai, kagent and Gemini CLI  
...
3. [Spec-Driven Cloud-Native Architecture: Governing AI Agents for Managed Services with Gemini CLI and SpecKit](https://claude.ai/public/artifacts/6025a232-6ebe-4c42-bb51-02dbd4603e18)  
   

## **Requirements**

You are required to complete the **5-Phase "Evolution of Todo" Project** using Gemini CLI and Spec-Kit Plus. The core deliverables are:

* **Spec-Driven Implementation:** You must implement all **5 Phases** of the project (detailed below). You are strictly required to use **Spec-Driven Development**. You must write a Markdown Constitution and Spec for every feature of the phase, and use **Gemini CLI** to generate the implementation.  
  * *Constraint:* You cannot write the code manually. You must refine the *Spec* until Gemini CLI generates the correct output.  
...
| ----- | ----- | ----- | :---: | :---: |
| Phase I | In-Memory Python Console App | Python, Gemini CLI, Spec-Kit Plus | 100 | Dec 7, 2025 |
...
| :---- | :---: |
| Reusable Intelligence – Create and use reusable intelligence via Gemini CLI Subagents and Agent Skills | \+200 |
...
**Objective:** Build a command-line todo application that stores tasks in memory using Gemini CLI and Spec-Kit Plus.

## **Requirements**

* Implement all 5 Basic Level features (Add, Delete, Update, View, Mark Complete)  
* Use spec-driven development with Gemini CLI and Spec-Kit Plus  
...
* GEMINI.md with Gemini CLI instructions  
...
**Objective:** Using Gemini CLI and Spec-Kit Plus transform the console app into a modern multi-user web application with persistent storage.
...
| Spec-Driven | Gemini CLI \+ Spec-Kit Plus |
...
# **Monorepo Organization For Full-Stack Projects With GitHub Spec-Kit \+ Gemini CLI**

This guide explains how to organize your Full-Stack Projects in a monorepo to integrate **GitHub Spec-Kit** for spec-driven development with **Gemini CLI**. This guide explains how to organize your repository so that Gemini CLI and Spec-Kit Plus can effectively edit both frontend (Next.js) and backend (FastAPI) code in a single context.
...
│       ├── components.md  
│       └── pages.md  
├── GEMINI.md                     \# Root Gemini CLI instructions  
├── frontend/  
│   ├── GEMINI.md  
│   └── ... (Next.js app)  
├── backend/  
...
Create multiple GEMINI.md files to provide context at different levels:
...
# **Workflow with Spec-Kit \+ Gemini CLI**

* Write/Update Spec → @specs/features/new-feature.md  
* Ask Gemini CLI to Implement → "Implement @specs/features/new-feature.md"  
* Gemini CLI reads: Root GEMINI.md, Feature spec, API spec, Database spec, Relevant GEMINI.md  
* Gemini CLI implements in both frontend and backend  
* Test and iterate on spec if needed

# **Referencing Specs in Gemini CLI**
...
| **/GEMINI.md** | How to navigate and use specs |
| **/frontend/GEMINI.md** | Frontend-specific patterns |
| **/backend/GEMINI.md** | Backend-specific patterns |

**Key Point:**   
Spec-Kit provides organized, structured specs that Gemini CLI can reference. The GEMINI.md files tell Gemini CLI how to use those specs and project-specific conventions.

# **Summary: Monorepo vs Separate Repos**

| Approach | Pros | Cons |
| :---- | :---- | :---- |
| **Monorepo ⭐** | Single GEMINI.md context, easier cross-cutting changes | Larger repo |
| Separate Repos | Clear separation, independent deployments | Gemini CLI needs workspace setup |

**Recommendation:**   
Use monorepo for the hackathon – simpler for Gemini CLI to navigate and edit both frontend and backend in a single context.

# **Key Benefits of This Structure**

| Benefit | Description |
| :---- | :---- |
| **Single Context** | Gemini CLI sees entire project, can make cross-cutting changes |
| **Layered GEMINI.md** | Root file for overview, subfolder files for specific guidelines |
...
**Objective:** Create an AI-powered chatbot interface for managing todos through natural language using MCP (Model Context Protocol) server architecture and using Gemini CLI and Spec-Kit Plus.
...
*Note: If Docker AI (Gordon) is unavailable in your region or tier, use standard Docker CLI commands or ask Gemini CLI to generate the `docker run` commands for you.*
...
Can Spec-Driven Development be used for infrastructure automation, and how we may need to use blueprints powered by Gemini CLI Agent Skills.
...
* CLAUDE.md with Gemini CLI instructions  
