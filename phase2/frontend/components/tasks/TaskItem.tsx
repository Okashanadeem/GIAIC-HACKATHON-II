  ...
  return (
    <div
      className={`
        ...
        group
        ${isHighlighted
          ? 'bg-gradient-to-r from-aurora-purple/10 to-aurora-pink/10 border-l-2 border-l-aurora-purple shadow-lg shadow-aurora-purple/10'
          : 'bg-background-elevated/50 hover:bg-white/5 hover:border-l-2 hover:border-l-aurora-purple/50'
        }
      `.replace(/\s+/g, ' ').trim()}
    >
      {/* Status checkbox */}
