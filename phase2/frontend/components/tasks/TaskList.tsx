...
export function TaskList({
  ...
  if (error) {
    return (
      <div className="glass-card rounded-xl border border-border-glow p-8">
  ...
  if (tasks.length === 0) {
    return (
      <div className="glass-card rounded-xl border border-border-glow">
  ...
  return (
    <div className="glass-card rounded-xl border border-border-glow overflow-hidden shadow-xl shadow-aurora-purple/10">
