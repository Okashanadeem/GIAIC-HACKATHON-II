    ...
    >
      <div
        className={`
          ...
          relative
          ${isUser
            ? 'bg-gradient-to-br from-aurora-purple via-aurora-pink to-aurora-cyan text-white rounded-br-md shadow-lg shadow-aurora-purple/20'
            : 'glass-card border border-border-glow text-text-primary rounded-bl-md'
          }
        `}
      >
