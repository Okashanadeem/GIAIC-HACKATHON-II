...
export function ChatInput({
  ...
  return (
    <div className="flex items-end gap-3 p-4 glass-card-strong border-t border-border-glow">
      {/* Input textarea with glass effect */}
      <textarea
        ref={textareaRef}
        value={message}
        ...
        className={`
          ...
          focus:outline-none focus:ring-2 focus:ring-aurora-purple/50 focus:border-aurora-purple
      ...
      {/* Send button with aurora gradient */}
      <button
        type="button"
        ...
        className={`
          ...
          hover:shadow-xl hover:shadow-aurora-purple/40 hover:scale-110
