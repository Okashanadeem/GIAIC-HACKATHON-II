          ...
          <div className="max-w-3xl mx-auto">
            ...
            {isLoading && (
              <div className="flex justify-start mb-4">
                <div className="glass-card border border-border-glow px-4 py-3 rounded-2xl rounded-bl-md">
                  <div className="flex items-center gap-2">
                    <div className="flex space-x-1">
                      <div className="w-2 h-2 bg-aurora-purple rounded-full animate-bounce" style={{ animationDelay: '0ms' }} />
                      <div className="w-2 h-2 bg-aurora-pink rounded-full animate-bounce" style={{ animationDelay: '150ms' }} />
                      <div className="w-2 h-2 bg-aurora-cyan rounded-full animate-bounce" style={{ animationDelay: '300ms' }} />
                    </div>
                    <span className="text-text-secondary text-body-sm">AI is thinking...</span>
                  </div>
                </div>
              </div>
            )}
