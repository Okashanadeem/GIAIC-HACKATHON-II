    ...
    <>
      ...
      <aside
        className={`
          ...
          w-72 glass-card-strong border-r border-border-glow
  ...
  return (
    <div
      className={`
        ...
        transition-all duration-fast
        ${isActive
          ? 'bg-gradient-to-r from-aurora-purple/10 to-aurora-pink/10 border-l-2 border-l-aurora-purple text-white shadow-lg shadow-aurora-purple/10'
          : 'hover:bg-white/5 hover:border-l-2 hover:border-l-aurora-purple/50 text-text-primary'
        }
      `}
      onClick={onSelect}
    >
      ...
      <svg
        ...
        strokeWidth={1.5}
        stroke="currentColor"
        className={`w-4 h-4 flex-shrink-0 ${isActive ? 'text-aurora-purple' : 'text-text-secondary'}`}
      >
        <path
          strokeLinecap="round"
      ...
      <button
        ...
        className={`
          ...
          hover:bg-accent-error/10 hover:text-accent-error
          transition-all duration-fast
        `}
