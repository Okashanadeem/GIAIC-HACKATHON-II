      ...
      <div className="flex-1 flex flex-col">
        ...
        <section className="flex-1 flex items-center justify-center px-4 sm:px-6 py-12 lg:py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              TaskFlow AI combines intelligent task management with natural language processing.
              Organize, prioritize, and complete your tasks through conversation with your AI assistant.
            </p>
              ...
              {isAuthenticated ? (
                ...
                <>
                  <Link
                    href="/register"
                    className="
                      px-8 py-4 bg-gradient-to-r from-aurora-purple via-aurora-pink to-aurora-cyan
                      text-white rounded-lg font-medium text-lg
                      hover:shadow-2xl hover:scale-105 glow-purple-hover
        ...
        <section className="px-4 sm:px-6 pb-16 lg:pb-24">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div
                className="
                  p-6 lg:p-8 glass-card rounded-xl
                  hover:glass-card-strong transition-all duration-fast
                  animate-fade-in motion-reduce:animate-none
                  group
                "
                style={{ animationDelay: '500ms' }}
              >
                <div className="w-14 h-14 bg-gradient-to-br from-aurora-purple to-aurora-pink rounded-xl flex items-center justify-center mb-5 glow-purple group-hover:scale-110 transition-transform">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-text-primary mb-3 bg-gradient-to-r from-aurora-purple to-aurora-pink bg-clip-text text-transparent">
                  AI-Powered Assistant
                </h3>
                <p className="text-text-secondary">
                  Manage tasks naturally through conversation. Just tell your AI what needs to be done.
                </p>
              </div>
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-aurora-blue to-aurora-cyan rounded-xl flex items-center justify-center mb-5 glow-cyan group-hover:scale-110 transition-transform">
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-text-primary mb-3 bg-gradient-to-r from-aurora-blue to-aurora-cyan bg-clip-text text-transparent">
                  Smart & Intuitive
                </h3>
                <p className="text-text-secondary">
                  Intelligent task organization with natural language understanding. Works beautifully on any device.
                </p>
              </div>
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-aurora-green to-aurora-cyan rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform" style={{ boxShadow: '0 0 20px rgba(16, 185, 129, 0.5)' }}>
                  <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                </div>
                <h3 className="text-xl font-semibold text-text-primary mb-3 bg-gradient-to-r from-aurora-green to-aurora-cyan bg-clip-text text-transparent">
                  Secure & Private
                </h3>
                <p className="text-text-secondary">
          ...
          <section className="px-4 sm:px-6 pb-16">
            ...
            >
              ...
              <p className="text-text-secondary mb-8 max-w-lg mx-auto">
                Join thousands of people who have simplified their task management with TaskFlow AI.
              </p>
              <Link
                href="/register"
                className="
