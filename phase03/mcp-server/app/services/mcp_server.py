...
- MCP Server mounted at /mcp via mcp.run(transport="streamable_http")
...
References:
- https://modelcontextprotocol.io/docs/develop/build
...
# Initialize MCP Server (run with streamable_http transport)
